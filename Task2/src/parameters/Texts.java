...
public class Texts {
    public static final String WELCOME_MSG = "Hello!\nPart 4. Task 2: Get collaborators and send invite to user via Rest Template.";
    ...
    public static final String REPOSITORIES_LIST_MSG = "Repositories of '%s' user:";
    ...
    public static final String INVITE_RESULT_SUCCESSFUL_MSG = "Invite for %s user was sended successfully";
    public static final String INVITE_RESULT_FAILED_MSG = "Invite for %s user was not sended successfully :(";
    public static final String COLLABORATOR_IS_TRUE_FOR_REPO_MSG = "User %s is a collaborator of %s repo.";
    public static final String COLLABORATOR_IS_FALSE_FOR_REPO_MSG = "User %s is NOT a collaborator of %s repo.";
    public static final String WAIT_TO_ACCEPT_INCITE_MSG = "Check user's mail and accept invite.\nAfter that, press enter to continue and check result of inviting.";
}
